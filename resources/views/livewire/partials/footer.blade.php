<div>
    <!-- =========={ FOOTER }==========  -->
    <footer class="text-gray-400 bg-black">
        <!--Footer content-->
        <div id="footer-content" class="relative pt-8 pb-6 xl:pt-16 xl:pb-12">
            <div class="px-3 mx-auto overflow-hidden xl:container sm:px-4 xl:px-2">
                <div class="flex flex-row flex-wrap -mx-3 lg:justify-between">
                    <div class="flex-shrink w-full max-w-full px-3 lg:w-2/5 lg:pr-16">
                        <div class="flex items-center mb-2">
                            <span class="mt-2 mb-2 text-3xl font-bold leading-normal text-gray-100">LaraNews</span>
                            <!-- <img src="src/img-min/logo.png" alt="LOGO"> -->
                        </div>
                        <p>
                            LaraNews is a news platform build with Laravel and Livewire.
                        </p>
                        <ul class="mt-6 mb-6 space-x-3 Lg:mb-0">
                            <!--facebook-->
                    ...
                    <div class="flex-shrink w-full max-w-full px-3 lg:w-3/5">
                        <div class="flex flex-row flex-wrap">
                            <div class="flex-shrink w-1/2 max-w-full mb-6 md:w-1/4 lg:mb-0">
                                <h4 class="mb-3 text-base leading-normal text-gray-100 uppercase">
                                    Product
                                </h4>
                                <ul>
                ...
                <div class="row">
                    <div class="text-center col-12 col-md">
                        <p class="my-3 d-block">
                            Copyright © 2024 LaraNews | All rights reserved.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <!-- =========={ SCROLL TO TOP }==========  -->
    <a href="#"
        class="fixed hidden p-4 text-gray-500 bg-gray-100 border border-gray-100 rounded back-top dark:bg-gray-900 dark:border-gray-800 right-4 bottom-4"
